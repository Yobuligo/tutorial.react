...
// UseState is a function (useState()) which provides a pair of variable and function to update that variable. 
// !!! Whenever the update function (the setter) is called it triggers a rerendering of a component where the variable of the useState is used.
// When calling a useState it can be initialized, but it is not mandatory.
// 
